...
break;
case 'dls':
$msg='<strong>Success!</strong> User Deleted Successfully !!';
$class='success';
break;
case 'dlf':
...
<a href="addusers.php"	<button type="button" class="btn btn-success btn-md waves-effect waves-light">Add New</button></a>
</div>
</div>
</div>
<div class="row">
...
<td>
<a href="addusers.php?emp_id=<?php echo base64_encode($product['id']) ?>" title="Message"><button type="button" class="btn btn-success btn-md waves-effect waves-light"><i class="bx bxs-edit-alt"></i> Edit</button></a>
<?php if(checkAssignCompany($product['id'])>0) {?>
<a id="<?php echo ($product['id']) ?>"  class=shw  href="#dispatchpopup"  data-bs-toggle="modal" data-bs-target="#dispatchpopup"><button  class="btn btn btn-danger btn-md waves-effect waves-light"><i class="bx bx-trash" ></i> Delete</button></a>
<?php }else{ ?>
...
var a=this.id;
var x="<a  href='employee.php?did="+a+"'><button class='btn btn-success'>Yes Delete it !!</button></a>";
$('#delbtn').html(x);
})
</script>
</body>
